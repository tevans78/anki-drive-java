...
public class AnkiConnectorNodeJS implements AnkiConnector {
    ...
    public AnkiConnectorNodeJS(String host, int port) throws IOException {
        this.host = host;
        this.port = port;
    ...
    public AnkiConnectorNodeJS(String host) throws IOException {
        this(host, 5000);
    }

    public AnkiConnectorNodeJS(AnkiConnectorNodeJS anki) throws IOException {
    ...
    public synchronized void connect(Vehicle vehicle) throws InterruptedException {
        ...
        // check if there is a notification listener -> if yes, remove it! (otherwise it
        // will be a listener we cannot track anymore...)
    ...
    public AnkiConnector duplicate() throws IOException {
        return new AnkiConnectorNodeJS(this);
    }
}
